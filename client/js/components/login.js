...
var Login = React.createClass({
  ...
  render: function() {
    ...
    return (
      <div className="login">
        <h1 className="form-header login-form-header">{headerText}</h1>
        <form className="form login-form" onSubmit={this.authenticate}>
          ...
          <input className="form-button login-form-button login-form-button-submit" type="submit" value="Submit" /><br />
